...
export default {
  ...
  avatars: {
    autoSave: 'Tu elección se guarda automáticamente. Selecciona un avatar bloqueado para saber cómo desbloquearlo.',
    ...
    loadFailed: 'No se pudieron cargar los avatares. Inténtalo de nuevo.',
    saveFailed: 'No se pudo confirmar el guardado. Revisa tu conexión e inténtalo de nuevo.',
    retry: 'Reintentar',
    empty: 'Aún no hay avatares disponibles.',
    goodName: 'Fuerzas del Bien',
    evilName: 'Fuerzas del Mal',
