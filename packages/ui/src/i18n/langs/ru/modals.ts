...
export default {
  ...
  chat: {
    ...
    open: 'Открыть чат',
    openUnread: 'Открыть чат, непрочитанных: {count}',
    close: 'Закрыть чат',
    history: 'История сообщений',
    empty: 'Сообщений пока нет. Начните общение.',
    unread: 'Новые сообщения',
    newMessages: 'Новых: {count}',
    latest: 'К последним сообщениям',
    send: 'Отправить сообщение',
    sending: 'Отправляется…',
    failed: 'Не отправлено',
    retry: 'Повторить',
    offline: 'Восстанавливаем соединение…',
    viewAuthor: 'Открыть карточку: {name}',
    closeProfile: 'Закрыть карточку',
  },
};
