...
export default {
  ...
  avatars: {
    autoSave: 'Выбор сохраняется автоматически. Нажмите на закрытый аватар, чтобы узнать, как его получить.',
    selected: 'Выбран',
    choose: 'Выбрать',
    howToUnlock: 'Как получить',
    saving: 'Сохраняем…',
    saved: 'Аватар сохранён',
    loading: 'Загружаем аватары…',
    loadFailed: 'Не удалось загрузить аватары. Попробуйте ещё раз.',
    saveFailed: 'Не удалось подтвердить сохранение. Проверьте соединение и повторите попытку.',
    retry: 'Повторить',
    empty: 'Аватары пока недоступны.',
    goodName: 'Силы света',
    evilName: 'Силы тьмы',
