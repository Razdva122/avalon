...
export const stats: { [key in TLanguage]: Dictionary<string> } = {
  en: {
    ...
    bestAsRole: 'Best as: {role}',
    winPercentage: '{percent}% wins',
  ...
  pt: {
    ...
    bestAsRole: 'Melhor como: {role}',
    winPercentage: '{percent}% de vitórias',
  ...
  ru: {
    ...
    bestAsRole: 'Лучший за роль: {role}',
    winPercentage: '{percent}% побед',
  ...
  'zh-CN': {
    ...
    player: '玩家',
    topPlayerTitle: '顶尖玩家',
    bestAsRole: '最佳角色：{role}',
    winPercentage: '胜率 {percent}%',
  ...
  es: {
    ...
    bestAsRole: 'Mejor como: {role}',
    winPercentage: '{percent}% de victorias',
