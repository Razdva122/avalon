...
export default {
  achievements: {
    ...
    different_player_count: 'A vida é uma série de escolhas',
    different_player_count_description: 'Vencer em jogos com 5, 6, 7, 8, 9, 10 jogadores',
    assassin_kills: 'Eu vejo pessoas mortas.',
    assassin_kills_description: "Matar @:{'roles.merlin'} 5 vezes",
    top_player: 'Campeão',
    top_player_description: 'Obter o primeiro lugar com qualquer personagem',
    ...
    useless_role: 'Papel inútil?!',
    useless_role_description: "Jogando como @:{'roles.cleric'}, enviar a primeira missão 5 vezes",
    still_worthy: 'Ainda digno!',
    still_worthy_description: "Usar @:{'addons.excalibur'} na quinta missão e vencer",
    detective: 'Yippee-ki-yay, filho da mãe!',
    detective_description: "Jogando como @:{'roles.merlin'}, verificar a lealdade de @:{'roles.mordred'}",
    mistakes_happen: 'Você age como se a loucura fosse contagiosa...',
    mistakes_happen_description:
      "Jogando no time das forças das trevas, estar em uma missão onde todos os participantes pressionam @:{'inGame.fail'}",
    serial_killer: 'Light Yagami',
    serial_killer_description: "Matar @:{'roles.merlin'}, @:{'roles.cleric'}, @:{'assassinate.lovers'}",
    wrong_choice: 'Eu não estou em perigo, Percival. Eu sou o perigo.',
    wrong_choice_description: "Jogando como @:{'roles.morgana'}, estar em três missões fracassadas",
    bodyguard: 'Facinho, facinho, limão espremidinho.',
