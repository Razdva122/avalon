...
export default {
  ...
  avatars: {
    autoSave: 'A escolha é salva automaticamente. Selecione um avatar bloqueado para saber como desbloqueá-lo.',
    ...
    loadFailed: 'Não foi possível carregar os avatares. Tente novamente.',
    saveFailed: 'Não foi possível confirmar o salvamento. Verifique sua conexão e tente novamente.',
    retry: 'Tentar novamente',
    empty: 'Nenhum avatar disponível ainda.',
    goodName: 'Forças do Bem',
    evilName: 'Forças do Mal',
