...
export default {
  ...
  profile: {
    ...
    autoSaveHint: 'Settings apply immediately — no save button needed.',
    username: 'Username',
    stats: 'Statistics',
    logout: 'Logout',
    language: 'Language',
  ...
  avatars: {
    autoSave: 'Your choice is saved automatically. Select a locked avatar to learn how to unlock it.',
    selected: 'Selected',
    choose: 'Choose',
    ...
    loadFailed: 'Could not load avatars. Please try again.',
    saveFailed: 'Could not confirm the save. Check your connection and try again.',
    retry: 'Try again',
    empty: 'No avatars are available yet.',
    goodName: 'Forces of Good',
    evilName: 'Forces of Evil',
